...
ax[0][0].text(0.94, ax[0][0].get_ylim()[1]*0.6, 'True value = 0.99', rotation=90,size=7)
ax[0][0].axvline(x=0.77,color='red',linestyle='dashed',linewidth=0.72)
ax[0][0].text(0.79, ax[0][0].get_ylim()[1]*0.6, 'RI-EN MAP = 0.77', rotation=90,size=7)
ax[0][0].axvline(x=0.75,color='black',linestyle='dashed',linewidth=0.72)
ax[0][0].text(0.71, ax[0][0].get_ylim()[1]*0.6, 'IES mean = 0.75', rotation=90,size=7)
ax[0][0].set_xlim([0,1])
...
ax[0][1].text(0.59, ax[0][1].get_ylim()[1]*0.6, 'True value = 0.57', rotation=90,size=7)
ax[0][1].axvline(x=0.81,color='red',linestyle='dashed',linewidth=0.72)
ax[0][1].text(0.83, ax[0][1].get_ylim()[1]*0.6, 'RI-EN MAP = 0.81', rotation=90,size=7)
ax[0][1].axvline(x=0.27,color='black',linestyle='dashed',linewidth=0.72)
ax[0][1].text(0.29, ax[0][1].get_ylim()[1]*0.6, 'IES mean = 0.27', rotation=90,size=7)
ax[0][1].set_xlim([0,1])
...
ax[1][0].text(0.82, ax[1][0].get_ylim()[1]*0.6, 'True value = 0.80', rotation=90,size=7)
ax[1][0].axvline(x=0.30,color='red',linestyle='dashed',linewidth=0.72)
ax[1][0].text(0.32, ax[1][0].get_ylim()[1]*0.6, 'RI-EN MAP = 0.30', rotation=90,size=7)
ax[1][0].axvline(x=0.10,color='black',linestyle='dashed',linewidth=0.72)
ax[1][0].text(0.12, ax[1][0].get_ylim()[1]*0.6, 'IES mean = 0.10', rotation=90,size=7)
ax[1][0].set_xlim([0,1])
...
ax[1][1].text(0.06, ax[1][1].get_ylim()[1]*0.6, 'True value = 0.04', rotation=90,size=7)
ax[1][1].axvline(x=0.39,color='red',linestyle='dashed',linewidth=0.72)
ax[1][1].text(0.41, ax[1][1].get_ylim()[1]*0.6, 'RI-EN MAP = 0.39', rotation=90,size=7)
ax[1][1].axvline(x=0.55,color='black',linestyle='dashed',linewidth=0.72)
ax[1][1].text(0.57, ax[1][1].get_ylim()[1]*0.6, 'IES mean = 0.55', rotation=90,size=7)
ax[1][1].set_xlim([0,1])
ax[1][1].set_xlabel('depletion',fontsize=8)
ax[1][1].set_ylabel('density',fontsize=8)

fig.tight_layout()
fig.savefig(os.path.join(figure_dir,'Figure12.pdf'),dpi='figure',format='pdf')
plt.close()